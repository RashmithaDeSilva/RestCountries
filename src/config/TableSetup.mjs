...
async function setupDatabase() {
    ...
    try {
        ...
        `);
        console.log("[INFO] - Subscription Users table created or already exists");
        ...
        `);
        console.log("[INFO] - API Keys Usage table created or already exists");

        if (ENV === "PROD") {
            // Set global event scheduler
            await pool.query(`SET GLOBAL event_scheduler = ON;`);
            console.log("[INFO] - Global event scheduler created or already exists");
            ...
            await pool.query(`
                ...
                END;
            `);
            console.log("[INFO] - Check expired subscriptions event created or already exists");
        }
        ...
        console.log("[INFO] - Insert api key usage on new user trigger created or already exists");
        ...
        await pool.query(`
            ...
            END;
        `);
        console.log("[INFO] - Subscription Expiry trigger created or already exists");
        ...
        await pool.query(`
            ...
            END;
        `);
        console.log("[INFO] - Update api key usage subscription trigger created or already exists");
